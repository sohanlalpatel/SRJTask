  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-md xl:max-w-md space-y-8">
        ...
        {/* Card */}
        <div className="bg-white py-6 sm:py-8 px-4 sm:px-6 md:px-8 shadow-xl rounded-lg border border-gray-200">
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            {loginError && (
              <div className="bg-red-50 border border-red-200 rounded-md p-3 sm:p-4">
                <div className="flex items-start sm:items-center">
                  <svg
                    className="h-5 w-5 text-red-400 mt-0.5 sm:mt-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                  ...
                  <p className="ml-2 sm:ml-3 text-xs sm:text-sm text-red-800">
                    {loginError}
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex justify-center py-2 px-4 rounded-md shadow-sm text-xs sm:text-sm md:text-base font-medium text-white transition-colors ${
                  isLoading
